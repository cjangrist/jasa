...
Firecrawl, GitHub, SerpAPI, and Serper are the currently integrated usage
sources; configured providers without an integration remain explicit as
...
uses its unmetered authenticated rate-limit endpoint; SerpAPI and Serper use
their free account endpoints.
