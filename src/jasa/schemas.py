...
_TIMEOUT_DESCRIPTION = (
    ...
    " budget, which waits for every provider and leaves grounding the time it"
    " needs. A short value starves grounding and returns ungrounded snippets,"
    " or fails the call outright if the budget runs out before grounding"
    " begins."
)
